...
const faqData = [
  {
    ...
    answer:
      "스토어에서 원하는 전자책을 선택한 후 '구매하기' 버튼을 눌러주세요. 카카오페이, 신용카드 등 다양한 결제 수단을 지원합니다. 결제가 완료되면 내서재에서 바로 열람할 수 있습니다.",
  },
  {
    id: 2,
    category: "purchase",
    ...
    answer:
      "현재 카카오페이, 신용카드, 체크카드, 무통장 입금을 지원하고 있습니다. 추후 더 다양한 결제 수단이 추가될 예정입니다.",
  },
  {
    id: 3,
    category: "refund",
    ...
    answer:
      "구매 후 7일 이내, 전자책을 열람하지 않은 경우에 한해 전액 환불이 가능합니다. 내 정보 > 구매 내역에서 환불 요청을 하시거나, 1:1 문의를 통해 요청해주세요.",
  },
  {
    id: 4,
    category: "refund",
    ...
    answer:
      "전자책은 디지털 콘텐츠 특성상 부분 환불은 지원되지 않습니다. 전체 환불만 가능하며, 환불 조건(구매 후 7일 이내, 미열람)을 충족해야 합니다.",
  },
  {
    id: 5,
    category: "reader",
    ...
    answer:
      "구매한 전자책은 웹 브라우저에서 제공되는 웹 뷰어를 통해 읽을 수 있습니다. PC, 태블릿, 모바일 등 다양한 기기에서 접속 가능합니다. 별도의 앱 설치 없이 로그인만 하면 내서재에서 바로 열람하실 수 있어요.",
  },
  {
    id: 6,
    category: "reader",
    ...
    answer:
      "저작권 보호를 위해 전자책 다운로드는 지원하지 않습니다. 웹 뷰어를 통해서만 열람이 가능하며, 구매한 전자책은 계정이 유지되는 한 언제든지 다시 읽을 수 있습니다.",
  },
  {
    id: 7,
    category: "account",
    ...
    answer:
      "카카오 계정으로 간편하게 가입할 수 있습니다. 별도의 이메일 인증이나 복잡한 절차 없이, 카카오 로그인 버튼을 누르면 자동으로 회원가입이 완료됩니다.",
  },
  {
    id: 8,
    category: "account",
    ...
    answer:
      "디하북스는 카카오 로그인만 지원하므로 별도의 비밀번호가 없습니다. 카카오 계정의 비밀번호를 분실하셨다면 카카오 고객센터를 통해 비밀번호를 재설정해주세요.",
  },
  {
    id: 9,
    category: "seller",
    ...
    answer:
      "내 정보 > 전문가 전환을 통해 판매자 등록을 할 수 있습니다. 판매자 등록 후 전자책을 업로드하면 심사를 거쳐 스토어에 등록됩니다.",
  },
  {
    id: 10,
    category: "seller",
    ...
    answer:
      "매월 1일~말일까지의 판매 금액이 익월 15일에 등록된 계좌로 정산됩니다. 수수료는 판매가의 20%이며, 정산 내역은 전문가 대시보드에서 확인할 수 있습니다.",
  },
];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 bg-secondary/30">
        <div className="container px-4 py-6 tablet:py-10 max-w-3xl mx-auto">
          {/* Header */}
          ...
          <div className="space-y-2">
            {filtered.length === 0 ? (
              ...
              filtered.map((faq, index) => {
                ...
                const catLabel = faqCategories.find(
                  (c) => c.id === faq.category
                )?.label;
                    ...
                    {isOpen && (
                      <div className="px-4 tablet:px-5 pb-4 tablet:pb-5">
                        <div className="flex gap-3 pt-3 border-t border-border">
                          <span className="text-xs font-bold text-foreground bg-secondary px-2 py-0.5 rounded-full shrink-0 h-fit">
                            A
                          </span>
